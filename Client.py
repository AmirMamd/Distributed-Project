...
class CarRacing:
    ...
    def initialize(self):
        ...
        self.carImg1 = pygame.image.load('.\\Car Racing Game using Pygame\\img\\car.png')
        self.car_x_coordinate = (self.display_width * 0.45)
        self.car_y_coordinate = (self.display_height * 0.8)
        # Player.__init__(self,self.carImg,self.car_x_coordinate,self.car_y_coordinate)
        self.car1_x_coordinate = (self.display_width * 0.45)
        self.car1_y_coordinate = (self.display_height * 0.8)
